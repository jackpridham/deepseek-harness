...
For summary truncation, the direct result preserves the backend's cap and recovery diagnostic instead of the generic summary message. It leaves the original conversation intact.
