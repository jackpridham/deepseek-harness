...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'settings.models.catalog.actions',
    kind: 'list',
    scope: 'root',
    summary: 'Optional controls rendered beside one Host catalog row.',
    doc: 'Optional controls rendered beside one Host catalog row.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.models.catalog.actions\', () => ctx.slots.register(\n      { name: \'settings.models.catalog.actions\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings-models/src/client/ModelsSection.tsx:61',
  },
  {
    key: 'settings.models.selection',
    kind: 'single',
    scope: 'root',
    summary: 'Composer-owned picker rendered for Settings\' existing active chat.',
    doc: 'Composer-owned picker rendered for Settings\' existing active chat.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'settings.section\' (client-ui-settings-models), so it exists while that entry is mounted',
    occupants: [
      'client-ui-model-selection ({ sessionId, t }: PropsRuntime<\'settings.models.selectio…',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.models.selection\', () => ctx.slots.register(\n      { name: \'settings.models.selection\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-settings-models/src/client/ModelsSection.tsx:63',
  },
  {
