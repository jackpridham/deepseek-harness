...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-policy-unavailable'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('session-policy-conflict'), message: z.string(), details: z.object({ sessionId: z.string(), requestedMode: z.string(), existingMode: z.string() }) }),
  z.object({ code: z.literal('session-policy-invalid'), message: z.string(), details: z.object({}) }),
