...
export interface RpcErrorDetailsMap {
  ...
  'session-not-advisory': { sessionId: SessionId }
  'session-mode-conflict': { sessionId: SessionId; requestedMode: 'ordinary' | 'advisory'; existingMode: 'ordinary' | 'advisory' }
  'advisory-session-invalid': {}
