...
import type { VortexModelsApi } from './models.ts'
...
export interface RpcMethodMap {
  ...
  'vortex.models.snapshot': VortexModelsApi['snapshot']
  'vortex.models.operation': VortexModelsApi['operation']
  'vortex.models.operationStatus': VortexModelsApi['operationStatus']
}
