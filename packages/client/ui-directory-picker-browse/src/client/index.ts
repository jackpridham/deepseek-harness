  ...
  ctx.effect(() => {
    ...
    const dictionaries: [locale: string, dict: Record<string, string>][] = [
      ['zh', {
        ...
        'browser.newFolderUnavailable': '此目录为只读，或您没有新建文件夹的权限。',
      ...
      ['en', {
        ...
        'browser.newFolderUnavailable': 'This directory is read-only or you do not have permission to create folders.',
