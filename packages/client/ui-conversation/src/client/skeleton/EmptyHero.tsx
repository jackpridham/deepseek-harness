// Blank-draft chrome for ConversationRoot: glow backdrop and workspace row.
// Pure presentation — the resident
 ...
 * owner (ConversationRoot), so it can center on the input card; the owner's
 * className supplies all positioning.
