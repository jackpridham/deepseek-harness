...
- **No arbitrary context input** — the composer offers only endpoint-advertised, exact-model context tiers; a model without bounded choices leaves the Context row absent.
