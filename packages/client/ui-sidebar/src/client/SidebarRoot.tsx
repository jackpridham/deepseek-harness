    ...
    >
      <div className={css.logoRow}>
        ...
        {wide && (
          ...
          >
            <span className={css.brandName} aria-hidden="true">
              {renderSlot('sidebar.brand.name', {}, {
                fallback: (
                  <>
                    <span className={css.fallbackBrandName}>Vortex Harness</span>
        ...
        {/* The panel icon is the collapsed and expanded fold affordance. */}
