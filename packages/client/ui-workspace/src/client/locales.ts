...
export const zh = {
  ...
  'delete.desc': '这将永久删除“{name}”的文件夹、所有会话、记录、转录、备份、生成文件以及未被其他会话引用的附件。此操作无法撤销。',
...
export const en = {
  ...
  'delete.desc': 'This permanently deletes “{name}”, its folder, every session, logs, transcripts, backups, generated files, and attachments not referenced by another session. This cannot be undone.',
