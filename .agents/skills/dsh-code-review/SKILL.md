...
- Translation review is outside automatic review and runs only when the user explicitly requests translation work.
...
- **Documentation language:** do not request a companion translation for an English documentation change. Review translations only when they are explicitly part of the requested scope.
