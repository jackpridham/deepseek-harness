 ...
 * maps to exactly one English `docs/subsystems/` page through the curated tables below;
 * the generator injects each page's Cordis API reference between its GENERATED markers. The
 ...
 * runtime API module, plus each mapped subsystem page's updated English
...
export function main(): void {
  ...
  console.log(`gen-cordis-catalog: ${outputs.length} English artifact(s) computed, ${changedPages} written.`)
}
