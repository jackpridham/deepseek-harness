...
<a id="sessioninstructions--log-only"></a>

#### `session/instructions` — log-only
...
Source: [`packages/session/session-title/src/index.ts:114`](../packages/session/session-title/src/index.ts)
